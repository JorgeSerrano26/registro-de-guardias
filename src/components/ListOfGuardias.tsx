...
const ListOfGuardias = () => {
    const { guardias } = useApp();
    const sortedDates = useMemo(() => sortDates(guardias), [guardias]);
    ...
    return <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <h3 className="text-lg font-semibold text-gray-900 ">Listado de guardias</h3>
